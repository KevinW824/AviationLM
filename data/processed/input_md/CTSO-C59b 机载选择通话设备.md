...
本技术标准规定(CTSO)适用于为机载选择通话设备申请技术
标准规定项目批准书(CTSOA)的制造人。本CTSO 规定了机载选
择通话设备为获得批准和使用适用的CTSO 标记进行标识所必须满
足的最低性能标准。 
...
标识的机载选择通话设备应满足RTCA DO-93A《机载选择通话设备
最低性能标准》
(2016.3.17)最低性能标准和文件要求。 

a.功能 
本CTSO 的标准适用于预期允许单架飞机通过连接地面站和飞
机的正常的无线电通话通道进行选择呼叫的设备。
该系统是针对操作
现存的高频(HF)和甚高频(VHF)地对空发射机和接收机设计的。
每个有选择呼叫功能的飞机都分配唯一标识,
该标识使得地面站能够
告知机组人员需要建立通讯联络。 
...
(2)本CTSO 第3.a 节定义的功能丧失属微小的失效状态。对
于主通信系统和应急通信系统,跨洋/远距离运行的风险是微小的。
一路高频通信作为主通信系统,
要求另有一路高频无线电作为应急通
信系统。 
(3)设备的设计保证等级应至少与这种失效状态类别相对应。 
c. 功能鉴定 
应按RTCA/DO-93A 第2.4 节中试验条件,证明设备性能满足要
求。 
d. 环境鉴定 应按RTCA/DO-93A 第2.3 节中试验条件,采用该设备适用的标
准环境条件和试验程序,证明设备性能满足要求。申请人可采用除
RTCA/DO-160G 以外其它适用于机载选择通话设备的标准环境条件
和试验程序。 
