...
本技术标准规定(CTSO)适用于为航姿基准系统(AHRS)申
请技术标准规定项目批准书(CTSOA)的制造人。本CTSO 规定了
航姿基准系统为获得批准和使用适用的CTSO 标记进行标识所必须
满足的最低性能标准。 
...
按本CTSO 批准的
设备,其设计大改应按CCAR-21R4 第21.353 条要求重新申请
CTSOA。 

## 3.要求

在本CTSO生效之日或生效之后制造并欲使用本CTSO标记进行
标识的航姿基准系统应满足RTCA/DO-334《固态捷联航姿基准系统
最低运行性能标准》
(2012.3.21)第2.1,2.2.1 和2.2.2 节中的最低性
能标准和文件要求。如果AHRS 使用辅助(信号)提供包括显示在 内的航向、滚转和侧滑、降级模式功能,或向独立显示器提供AHRS
产生的信息,则申请人必须满足下表要求。 
...
a.功能 
本CTSO 的标准适用于输出俯仰角和滚转姿态
(不使用陀螺支架
器)的固态捷联AHRS 设备。同时考虑AHRS 所提供的航向、滚转、
侧滑和显示方面的可选择功能。 
...
c. 功能鉴定 
按照RTCA/DO-334 中2.4 节中试验条件,证明设备的性能满足
要求。如果AHRS 包括显示器,则应按照RTCA/DO-334 中第2.6 节
中的试验条件,证明设备性能满足要求。 

d. 环境鉴定 
应按RTCA/DO-334 第2.3 节中试验条件,采用该设备适用的标
准环境条件和试验程序,证明设备性能满足要求。RTCA/DO-334 要
求使用RTCA/DO-160G 《机载设备的环境条件与试验程序》
(2010.12.8)
,申请人可采用除RTCA/DO-160G 以外其它适用于
AHRS 的标准环境条件和试验程序,
证明设备满足最低性能标准要求
的性能。 
注:
...
验结果。 
k. 在安装手册中提供RTCA/DO-334 第1.7.1 节要求的AHRS 运
行模式以及高度、航向、滚转和侧滑类别。 
